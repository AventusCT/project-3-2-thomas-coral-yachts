...
if (isset($_SESSION['logged_in']))  {
    ...
    // <---------------------------------------------------------------- v Change Username v ----------------------------------------------------------------> //
      if(isset($_POST['changeUsernameBtn'])) {
        ...
        if (isset($_POST['password'], $_POST['new_username'],$_POST['hidden_id'])) {
          $password = $_POST['password'];
          $new_username = $_POST['new_username'];
          $user_id = $_POST['hidden_id'];
  
          if (empty($password) or empty($new_username)) {
    ...
    if(isset($_POST['changePasswordBtn'])) {
        ...
        // current password correct
        if (isset($_POST['current_password'], $_POST['new_password'],$_POST['hidden_id'])) {
          $current_password = $_POST['current_password'];
          $new_password = $_POST['new_password'];
          $user_id = $_POST['hidden_id'];

          if (empty($current_password) or empty($new_password)) {
              ...
              $query->bindValue(1, $user_id);
              $query->bindValue(2, $current_password);
    ...
    if(isset($_POST['changeNameBtn'])) {
        ...
        // current password correct
        if (isset($_POST['password'], $_POST['new_name'],$_POST['hidden_id'])) {
          $password = $_POST['password'];
          $new_name = $_POST['new_name'];
          $user_id = $_POST['hidden_id'];

          if (empty($password) or empty($new_name)) {
    ...
    if(isset($_POST['changeLastnameBtn'])) {
        ...
        // current password correct
        if (isset($_POST['password'], $_POST['new_lastname'],$_POST['hidden_id'])) {
          $password = $_POST['password'];
          $new_lastname = $_POST['new_lastname'];
          $user_id = $_POST['hidden_id'];

          if (empty($password) or empty($new_lastname)) {
    ...
    if(isset($_POST['changeEmailBtn'])) {
      ...
      // current password correct
      if (isset($_POST['password'], $_POST['new_email'],$_POST['hidden_id'])) {
        $password = $_POST['password'];
        $new_email = $_POST['new_email'];
        $user_id = $_POST['hidden_id'];

        if (empty($password) or empty($new_email)) {
    ...
    if(isset($_POST['changeTelephoneBtn'])) {
      ...
      // current password correct
      if (isset($_POST['password'], $_POST['new_telephone'],$_POST['hidden_id'])) {
        $password = $_POST['password'];
        $new_telephone = $_POST['new_telephone'];
        $user_id = $_POST['hidden_id'];

        if (empty($password) or empty($new_telephone)) {
        ...
        <section id="r-logged-in">
          ...
          <div class="container">
                <div>
                    ...
                    <a href="./user.php"  onMouseOver="this.style.color='#ffcd00'"
                    ...
                    <div class="r-auth-form">
                        <form action="update-user.php" method="POST">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="password" name="current_password" id="currentpasswordField" placeholder="Current Password"></input>
