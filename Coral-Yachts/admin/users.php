        ...
        <section id="r-logged-in">
          <div class="r-login-register">
            <div class="container">
                <div">
                    <h2><b>Logged in</b></h2>
                    <span><a class="cms-link-btn" href="add-user.php">Add user</a></span>
                    <span><a class="cms-link-btn" href="update-user.php">Update user information</a></span>
                    <span><a class="cms-link-btn" href="delete-user.php">Delete user</a></span><br/>
                        ...
                        <div class="r-best-offer-single">
                          <div class="r-best-offer-in">
                            ...
                            <div style="border-bottom: 3px solid #000000;" class="r-best-offer-content">
                                ...
                                <p><span style="font-weight:500; color:cadetblue;">User name = </span><?php echo $user['user_name']; ?></p>
                                <p><span style="font-weight:500; color:cadetblue;">Name = </span><?php echo $user['name']; ?></p>
                                <p><span style="font-weight:500; color:cadetblue;">Lastname = </span><?php echo $user['lastname']; ?></p>
                                <p><span style="font-weight:500; color:cadetblue;">Email = </span><?php echo $user['email']; ?></p>
                                <p><span style="font-weight:500; color:cadetblue;">Telephone = </span><?php echo $user['telephone']; ?></p>
                            </div>
                          </div>
                        </div>
                      </div>
