        ...
        <section id="r-logged-in">
          <div class="r-login-register">
            <div class="container">
                <div">
                    <h2><b>Logged in</b></h2>
                    <span><a class="cms-link-btn" href="add-reservation.php">Add Reservation</a></span>
                    <span><a class="cms-link-btn" href="update-reservation.php">Update user Reservation</a></span>
                      ...
                      <div class="col-xl-8 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="r-best-offer-single">
                          <div class="r-best-offer-in">
                            ...
                            <p><b>User Name</b> = <?php echo $reservation['user_name']; ?></p>
                                <p><span style="font-weight:500; color:cadetblue;">Reservation id = </span><?php echo $reservation['res_id']; ?></p>
                                <p><span style="font-weight:500; color:cadetblue;">Reservated Yacht name = </span><?php echo $reservation['yacht_name']; ?></p>
                                <p><span style="font-weight:500; color:cadetblue;">Reservated User name = </span><?php echo $reservation['user_name']; ?></p>
                                <p><span style="font-weight:500; color:cadetblue;">Start date = </span><?php echo $reservation['start_date']; ?></p>
                                <p><span style="font-weight:500; color:cadetblue;">End date = </span><?php echo $reservation['end_date']; ?></p>
                                <small style="border: 1px solid #200000;">
                                  <span style="font-weight:500; color:cadetblue;">Reservated Yacht id = <?php echo $reservation['res_yacht_id'];?> |</span>
                                  <span style="font-weight:500; color:cadetblue;">Yacht id = <?php echo $reservation['yacht_yacht_id'];?> |</span>
                                  <span style="font-weight:500; color:cadetblue;">Reservated User id = <?php echo $reservation['res_user_id'];?> |</span>
                                  <span style="font-weight:500; color:cadetblue;">User id = <?php echo $reservation['us_user_id'];?> </span>
                              </small>
                            </div>
                          </div>
                        </div>
