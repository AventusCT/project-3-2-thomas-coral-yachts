    ...
    if (isset($_SESSION['logged_in'])) {
      ...
      if(isset($_POST['deleteUserbtn'])) {
        ...
        if (isset($_POST['user_id'])) {
          ...
          $antierror = "Reservation of $user_name is deleted! (User id = $user_id)";
        }
      }
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
      <!-- PAGE TITLE -->
      <title>Delete User - Coral Yachts</title>
          ...
          <div class="r-login-register">
            <div class="container">
                <div">
                    ...
                    <div>
                    <small style="color:#aa0000;"><b>WARNING!</b>, The user selected will permanently get deleted!</small></div><br/><br/>
                            ...
                            <div class="form-group">
                                <select name="user_id">
                                    <?php foreach ($users as $user) { ?>
                                        ...
                                        <?php echo"User id="; echo $user['user_id']; ?> |<br/>
                                        </option>
                                    <?php } ?>
                                </select><br/><br/>
                                <input type="hidden" name="user_name" value="<?php echo $user['user_name'];?>"></input>
                                <input style="color:white;" name="deleteUserbtn" class="admin-btn" type="submit" value="Delete User">
                            </div>
                        </form>
                </div>
            </div>
