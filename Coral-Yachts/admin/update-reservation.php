...
include_once('../includes/connection.php');
    ...
    if(isset($_POST['changeYachtBtn'])) {
        ...
        if (isset($_POST['password'], $_POST['res_id'],$_POST['yacht_id'],$_POST['hidden_id'])) {
          $password = $_POST['password'];
          $res_id = $_POST['res_id'];
          $yacht_id = $_POST['yacht_id'];
          $admin_id = $_POST['hidden_id'];
  
          if (empty($password) or empty($res_id) or empty($yacht_id)) {
    ...
    if(isset($_POST['changeStartdateBtn'])) {
      ...
      // current password correct
      if (isset($_POST['password'], $_POST['res_id'],$_POST['start_date'],$_POST['hidden_id'])) {
        $password = $_POST['password'];
        $res_id = $_POST['res_id'];
        $start_date = $_POST['start_date'];
        $admin_id = $_POST['hidden_id'];

        if (empty($password) or empty($res_id) or empty($start_date)) {
    ...
    if(isset($_POST['changeEnddateBtn'])) {
      ...
      // current password correct
      if (isset($_POST['password'], $_POST['res_id'],$_POST['end_date'],$_POST['hidden_id'])) {
        $password = $_POST['password'];
        $res_id = $_POST['res_id'];
        $end_date = $_POST['end_date'];
        $admin_id = $_POST['hidden_id'];

        if (empty($password) or empty($res_id) or empty($end_date)) {
                            ...
                            <div class="form-group">
                                ...
                                <select name="res_id">
                                    <?php foreach ($reservations as $reservation) { ?>
                                        <option value="<?php echo $reservation['res_id'];?>">
                                        <?php echo $reservation['user_name']; ?> |<br/>
                                        <?php echo"User id="; echo $reservation['us_user_id']; ?> |<br/>
                                        <?php echo"Reservation id="; echo $reservation['res_id']; ?><br/>
                                        </option>
                                    <?php } ?>
                                </select><br/><br/>
                    ...
                    <div class="r-auth-form">
                        <form action="update-reservation.php" method="POST">
                            <div class="form-group">
                                ...
                                <label for="changestartdateField">Change Start date:</label><br/>
                    ...
                    <div class="r-auth-form">
                        <form action="update-reservation.php" method="POST">
                            <div class="form-group">
                                ...
                                <label for="changeuseryachtField">Change End date:</label><br/>
