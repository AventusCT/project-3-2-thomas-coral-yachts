...
if (isset($_SESSION['logged_in']))  {
    ...
    include_once('../admin/handlers/add-reservation_handler.php')
    ?>
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
      <!-- PAGE TITLE -->
      <title>Add Reservation - Coral Yachts</title>
                    ...
                    <div class="r-auth-form">
                        <form action="add-reservation.php" method="POST">
                            ...
                            <select name="yacht_id">
                                ...
                                <label for="changestartdatetField">Start date</label><br/>
                                <input class="form-control" type="date" name="start_date" placeholder="start date"/>
                                <label for="changeenddatetField">End date</label><br/>
                                <input class="form-control" type="date" name="end_date" placeholder="end date"/>
                                <input style="color:white;" name="addReservationbtn" class="admin-btn" type="submit" value="Add Reservation">
                            </div>
                        </form>
                    </div>
                </div>
