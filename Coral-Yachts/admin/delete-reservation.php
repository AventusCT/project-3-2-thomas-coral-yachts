...
if (isset($_SESSION['logged_in'])) {
    ...
    if(isset($_POST['deleteReservationbtn'])) {
      ...
      if (isset($_POST['res_id'])) {
        ...
        $query->execute();
        $antierror = "Reservation of $user_name is deleted! (Reservation number $res_id)";
      }
    }
                            ...
                            <div class="form-group">
                                <select name="res_id">
                                    <?php foreach ($reservations as $reservation) { ?>
                                        ...
                                        <?php echo"Reservation id="; echo $reservation['res_id']; ?>
                                        </option>
                                    <?php } ?>
                                </select><br/><br/>
                                <input type="hidden" name="user_name" value="<?php echo $reservation['user_name'];?>"></input>
