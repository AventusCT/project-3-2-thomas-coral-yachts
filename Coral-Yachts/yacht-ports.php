          ...
          <div class="r-header r-header-inner">
            ...
            <div class="r-header-inner-banner">
              <div class="r-header-in-over">
                <h1> <b>Yacht Ports</b> </h1>
                <div class="r-breadcrum">
                  <ul>
                    <li><a href="index.php">HOME</a></li>
                    <li><span>YACHT PORTS</span></li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div class="row clearfix">
              ...
              <?php 
                ...
                <div class="r-contact-address">
                  <div class="head">Amsterdam Port</div>
                  <div class="r-contact-img"><img src="<?php echo $yacht['yacht_port_img'];?>" class="img-fluid d-block m-auto" alt=""></div>
                  <div class="address address-cnt"><i class="fa fa-map-marker"></i><b>300</b> Amsterdam, The Netherlands</div>
                  <div class="call address-cnt"><i class="fa fa-phone"></i><b>+100</b>-1212-2000</div>
                  <div class="mail address-cnt"><i class="fa fa-envelope"></i>info@dutchcoralyachts.com</div>
                </div>
                <?php $count++; } ?>
                <div class="r-contact-address">
                  <div class="head">Greece Port</div>
                  <div class="r-contact-img"><img src="<?php echo $yacht['yacht_port_img'];?>" class="img-fluid d-block m-auto" alt=""></div>
                  <div class="address address-cnt"><i class="fa fa-map-marker"></i><b>300</b> Athens, Greece</div>
                  <div class="call address-cnt"><i class="fa fa-phone"></i><b>+100</b>-1212-2000</div>
                  <div class="mail address-cnt"><i class="fa fa-envelope"></i>info@creekcoralyachts.com</div>
                </div>
              </div>

              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="r-contact-address">
                  <div class="head">Ibiza Port</div>
                  <div class="r-contact-img"><img src="<?php echo $yacht['yacht_port_img'];?>" class="img-fluid d-block m-auto" alt=""></div>
                  <div class="address address-cnt"><i class="fa fa-map-marker"></i><b>300</b> Ibiza, Spain</div>
                  <div class="call address-cnt"><i class="fa fa-phone"></i><b>+100</b>-1212-2000</div>
                  <div class="mail address-cnt"><i class="fa fa-envelope"></i>info@spanishcoralyachts.com</div>
                </div>
              </div>
            </div>
          </div>
